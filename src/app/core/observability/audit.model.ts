...
export const AUDIT_ACTIONS = [
  ...
  'question.published',
  'question.versioned',
  'question.submitted_review',
  'question.resubmitted',
  'question.approved',
  'question.revision_requested',
  'question.rejected',
  'blueprint.created',
  'blueprint.updated',
  'blueprint.deleted',
...
export const AUDIT_ACTION_LABELS: Readonly<Record<AuditAction, string>> = {
  ...
  'question.submitted_review': 'Soru incelemeye gönderildi',
  'question.resubmitted': 'Soru yeniden incelemeye gönderildi',
  'question.approved': 'Soru onaylandı',
  'question.revision_requested': 'Soru için revizyon istendi',
  'question.rejected': 'Soru reddedildi',
